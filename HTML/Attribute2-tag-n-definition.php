...
$attributes = [
	...
	'autocomplete'        => ['form,input', 'Specifies whether theform> or theinput> element should have autocomplete enabled'],
	...
	'checked'             => ['input', 'Specifies that aninput> element should be pre-selected when the page loads (for type="checkbox" or type="radio")'],
	...
	'list'                => ['input', 'Refers to adatalist> element that contains pre-defined options for aninput> element'],
	...
	'oncuechange'         => ['track', 'Script to be run when the cue changes in atrack> element'],
	...
	'onsearch'            => ['input', 'Script to be run when the user writes something in a search field (forinput type="search">)'],
	...
	'ontoggle'            => ['details', 'Script to be run when the user opens or closes thedetails> element'],
	...
	'pattern'             => ['input', 'Specifies a regular expression that aninput> element\'s value is checked against'],
	...
	'sandbox'             => ['iframe', 'Enables an extra set of restrictions for the content in aniframe>'],
	...
	'size'                => ['input,select', 'Specifies the width, in characters (forinput>) or specifies the number of visible options (forselect>)'],
	...
	'srcdoc'              => ['iframe', 'Specifies the HTML content of the page to show in theiframe>'],
...
foreach ($attributes as $attr => $ary) {
	$ant[$attr] = $ary[0];
	$fill[] = [
		'attribute'  => $attr,
		'belongs-on' => $ary[0],
